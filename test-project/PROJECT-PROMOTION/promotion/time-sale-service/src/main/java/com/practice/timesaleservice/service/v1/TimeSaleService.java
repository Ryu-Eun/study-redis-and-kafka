package com.practice.timesaleservice.service.v1;

import com.practice.timesaleservice.dto.TimeSaleDto;
import com.practice.timesaleservice.entity.Product;
...
import com.practice.timesaleservice.repository.ProductRepository;
...
public class TimeSaleService {
    ...
    public TimeSale createTimeSale(TimeSaleDto.CreateRequest request){
        ...
        validateTimeSale(request.getQuantity(), request.getDiscountPrice(), request.getStartAt(), request.getEndAt());
