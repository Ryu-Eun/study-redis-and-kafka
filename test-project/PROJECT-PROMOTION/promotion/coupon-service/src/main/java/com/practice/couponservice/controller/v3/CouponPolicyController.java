package com.practice.couponservice.controller.v3;
...
public class CouponPolicyController {
    ...
    @PostMapping
    public ResponseEntity<CouponPolicyDto.Response> createCouponPolicy(@RequestBody CouponPolicyDto.CreateRequest request) throws JsonProcessingException, JsonProcessingException {
